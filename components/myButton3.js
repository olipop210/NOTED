...
export default function MyButton3(props){
    ...
    return(
        ...
        <Svg width={props.szerokosc - 5} height={props.wysokosc - 5}>
            ...
            <View style={{ width: props.szerokosc, height: props.wysokosc, alignItems: 'center', justifyContent: 'center'}}>
            <NativeText numberOfLines={2} style={{color: 'white', textAlign: 'center', fontSize: props.rozmiarCzcionki, textAlignVertical: 'center', marginTop: -0.3*props.rozmiarCzcionki}}>{props.tekst}</NativeText>
            </View>
        </Svg>
